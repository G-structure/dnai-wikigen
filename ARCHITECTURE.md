...
[partial]   The client-configuration diagnostic source follow-up changes the
            ...
            SBOM attestations for that digest. Local rendered-compose
            ...
            yet checked with the Phala raw-compose/allowed-env deploy mode,
            redeployed, TDX-verified, or approved on-chain.
