...
PHASE 1: TINKER SIGNUP  LOCAL VALIDATED — deployed CVM validation pending
  ...
  `browser_unavailable` JSON on browser errors. It has not yet been pinned into
  a GitHub-built Phala image or used to capture live CVM selector/frame evidence.
